({ "81.cn":{ _name:"中国军网",
  ...
  "06se.com":{ _name:"06se",
    ".":[ { title:"06se",
      ...
      { title:"06se - 分类分页范围",
        docs:"https://docs.rsshub.app/routes/picture",
        source:[ "/:category/page/:page" ],
        target:"/06se/:category/page/:pageRange" },
      { title:"06se - 秀人网分页",
        docs:"https://docs.rsshub.app/routes/picture",
        source:[ "/xiuren/page/:page" ],
        target:"/06se/xiuren/:page" } ] },
  ...
  "hrbust.edu.cn":{ _name:"哈尔滨理工大学",
    ...
    nic:[ { title:"网络信息中心",
      ...
      { title:"网络信息中心",
        ...
        source:[ "/" ],
        target:"/hrbust/nic/" } ] },
  "html5games.com":{ _name:"html5games",
    ".":[ { title:"All Games",
        docs:"https://docs.rsshub.app/routes/game",
        source:[ "/All-Games" ],
        target:"/html5games/all" } ] },
